   ...
   <table border 1 cellplacing = 0>
      ...
      <tbody>
         ...
         <tr>
            ...
            <td><a href="cart.php?remove=<?php echo $fetch_cart['product_id']; ?>" onclick="return confirm('remove item from cart?')" class="delete-btn"> <i class="fas fa-trash"></i> remove</a></td>
         </tr>
         <?php
         ...
         <tr class="table-bottom">
            <td><a href="home.php" class="option-btn" style="margin-top: 0;">continue designing</a></td>
